...
```
- これで、githubにあなたの作業が（全世界に）公開されました。
### 解説
- git pushすることで、自分の作業内容をチームメンバーに伝えられます。
...
プルリクエスト発行
==
- 自分の変更内容をメンバーに確認してもらうためにはgithubサイト上でプルリクエストなるものを発行します。
- プルリクエストは、
...
レビュー実施
==
- 他の人の作業内容を確認し、プロジェクトに取り込むべきかを判断する「レビュー」を実施します。
- ブラウザで以下にアクセスしてください。
