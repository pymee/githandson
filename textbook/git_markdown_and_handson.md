...
- リモートリポジトリの設定作業が不要なので、git initよりおすすめ。
---
...
- 作業の単位を今回は便宜上「プロジェクト」と呼びます。今回のプロジェクトは「自分のプロフィールファイルを作成しよう」です。
...
- 初めてリポジトリを作る時に、github上で作成してからローカルに持ってくるときにも使います。
...
git初期設定補足
==
- 個人PCなど、AWS貸出環境で設定している方は、以下でもOKです。
```
